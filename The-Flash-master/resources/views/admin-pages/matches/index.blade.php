...
@section('content')
    <x-create-form title="Create New Match" :columnsName="$matches"></x-create-form>
    <x-edit-form title="Edit Match" :columnsName="$matches"></x-edit-form>
    <x-delete-modal title="Delete Confirmation" content="Are you sure you want to delete it!"></x-delete-modal>
    <x-jquery-data-table :records="$records" :columnsName="$matches" title="Matches Management" subTitle="You can manage Matches in here"></x-jquery-data-table>
    ...
    <script>
        ...
        createFormSubmitBtn.onclick = function(e) {
            ...
            apiService.post('/api/match/store', dataSubmit);
    ...
    <script>
        ...
        editFormSubmitBtn.onclick = function(e) {
            ...
            apiService.put('/api/match/update', editDataSubmit);
    ...
    <script>
        ...
        confirmDeleteBtn.onclick = function() {
            apiService.delete('/api/match/delete/' + document.getElementById('idToDelete').value);
